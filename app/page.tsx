  ...
  return (
    <main className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#0a0a1a] py-4">
      ...
      <div className="relative z-10 w-full max-w-[340px] px-4 text-center">
        ...
        {/* NAGŁÓWEK Z KOLOREM POBRANYM ZE ZDJĘCIA */}
        <div className="mb-6">
          {/* Czysta biała ramka */}
          <div className="inline-block border-[3px] border-white px-7 py-3 rounded-xl mb-4 shadow-xl">
            {/* Kolor tekstu: Ciemny Fioletowo-Niebieski pobrany ze wzoru */}
            <p className="text-[#4A4AE2] text-[19px] font-black uppercase tracking-[0.3em]">
              KARTA RABATOWA
            </p>
          </div>
        ...
        <div className="mb-5 space-y-1">
          ...
          {/* ŻÓŁTY PRZYCISK TELEFONU */}
          {!isRegistering && (
            <div className="pt-2">
              <a 
                href="tel:+48818260237" 
                className="inline-flex items-center gap-2 bg-[#FFD700] hover:bg-[#FFC700] text-black px-4 py-2 rounded-full transition-all active:scale-95 shadow-lg"
              >
        ...
        {/* FORMULARZ I PRZYCISKI (bez zmian, dla spójności) */}
        <form onSubmit={handleAuth} className="space-y-3">
          <input
            ...
            className="w-full bg-white border-none p-3.5 rounded-xl text-gray-900 placeholder:text-gray-500 outline-none text-base shadow-inner"
          />
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-white border-none p-3.5 rounded-xl text-gray-900 placeholder:text-gray-500 outline-none text-base pr-12 shadow-inner"
            />
            <button
              type="button"
          ...
          {isRegistering && (
            <input
              ...
              className="w-full bg-white/95 border-none p-3.5 rounded-xl text-gray-900 placeholder:text-gray-500 outline-none text-base ring-2 ring-blue-500/50 shadow-inner"
            />
          )}
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-[#1A5CFF] hover:bg-[#0044FF] text-white font-bold py-4 rounded-xl shadow-lg transition-all active:scale-95 text-lg uppercase tracking-wider mt-1 disabled:opacity-50"
          >
